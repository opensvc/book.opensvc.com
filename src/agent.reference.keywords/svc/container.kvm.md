...
**Example:**
	...
	virtinst=virt-install --name {fqdn} --memory 2048 --vcpus 2 --disk size=8 --cdrom /path/to/rhel9.iso --os-variant rhel9

**Description:**

The command to use to create the container. Usually a `virt-install` command or a custom script.
