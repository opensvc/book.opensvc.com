...
The vdev list, including optional parity keywords, as would be passed to zpool
create.
...
The zone name the zpool refers to. If set, the zpool is activated in the zone
context.
